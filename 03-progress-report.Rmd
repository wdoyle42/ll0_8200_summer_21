...
1. Results of two different analyses that predict your dependent variable (conditional means and either regression or classification)
1. Two graphics that show the results of your analyses above. (e.g scatterplot, bar plot)
