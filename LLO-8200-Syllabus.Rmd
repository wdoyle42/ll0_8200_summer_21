...
There will be four progress reports for the final project, each worth 100 points. The progress reports will be due 24 hours prior to the week’s live session. No late progress reports will be accepted. Students will be given the steps to complete each progress report.
...
## Week 1. Welcome to Data Science: Tools of the Trade
...
## Week 2. Analyzing Data: Conditional Means
...
Chapter 2, Conditional Means: 02-conditional_means.Rmd Problem Sets

Problem Set 1 due 24 hours before Week 3 live session 
...
Cookbook for R:Bar and Line Graphs Cookbook for R: Plotting Distributions Lecture Notes

Chapter 3, Plotting Distributions and Conditional Means: 03-plot_means.Rmd Problem Sets

Problem Set 2 due 24 hours before Topic 4 live session

Final Project

First progress report due 24 hours before live session
...
Resources
Wickham: Data Import; Tidy Data Lecture Notes
Chapter 4, Flat Data 04-flat_data.Rmd Problem Sets
Problem Set 3 due 24 hours before Topic 5 live session Synchronous Session: Working with various data formats
...
Resources
Wickham: Model: Introduction; Model Basics; Model Building Lecture Notes
Chapter 5, Linear Regression 05-regression.Rmd
Problem Sets
Problem Set 4 due 24 hours before Topic 6 live session
...
Lecture Notes
Chapter 6, Scatterplots 06-scatterplots.Rmd Problem Sets
Problem Set 5 due 24 hours before Topic 7 live session Final Project
Second progress report due 24 hours before live session
...
rvest Tutorial
Lecture Notes
Chapter 7, Web Scraping and APIs, 07-webscrape.Rmd Problem Sets
Problem Set 6 due 24 hours before Topic 8 live session Synchronous Session: Accessing data from the web
...
learning (Vol. 6). New York, NY: Springer. Chapter 4 , Chapter 4 Lab R Code
...
Resources
Problem Sets
Problem Set 8 due 24 hours before Topic 10 live session

Final Project
Third progress report due 24 hours before live session
Lecture Notes
Chapter 9, Plots and Tables for Classification 09-plotting_classification.Rmd Synchronous Session: Presenting data, plots, and tables for classification
...
Wickham Many Models
Problem Sets
Problem Set 9 due 24 hours before Week 11 live session Lecture Notes
