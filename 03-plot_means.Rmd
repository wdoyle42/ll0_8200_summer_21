...
at%>%
  mutate(mean_income_group=ntile(MonthlyIncome,n=4))
...
mean(at$attrit[at$BusinessTravel=="Non-Travel"])
mean(at$attrit[at$BusinessTravel=="Travel_Frequently"])
mean(at$attrit[at$BusinessTravel=="Travel_Rarely"])
